    ...
    <Accordion type="multiple" className="space-y-4">
      ...
      <AccordionItem value="initial-squad">
        ...
        <AccordionContent className="text-sm text-muted-foreground space-y-3">
          ...
          <p className="mt-2">
            Total budget may not exceed <strong>$100</strong>, coming out to an
            average of ~$7.7 per player.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="weekly-lineup">
        ...
        <AccordionContent className="text-sm space-y-3 text-muted-foreground">
          <p>
            Before each Gameweek deadline you must choose a starting lineup of{" "}
            <strong>10 active players</strong>. Your lineup must include at
            least one of each position.
          </p>

          <p>
            You will also choose a captain whose points will be doubled, and a
            vice-captain (backup if captain doesn’t play). If a player is
            injured or doesn't play, they will be subbed by the first available
      ...
      <AccordionItem value="trades">
        ...
        <AccordionContent className="text-sm text-muted-foreground space-y-3">
          <p>
            After your initial squad selection, you may buy/sell players each
            Gameweek.
          </p>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Sale prices includes a 50% sell-on fee for profit (rounded down).
              For example, if you buy Jokic for $13.0 and his price rises to
              $13.5, your sale price will be $13.2
            </li>
          </ul>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="gameweeks">
        ...
        <AccordionContent className="text-sm text-muted-foreground space-y-2">
          <p>
            Gameweeks start each Monday and end on Sunday. After the Gameweek
            deadline passes, at 12:00 AM each Monday, any actions made
            afterwards will take effect in the following week.
          </p>
